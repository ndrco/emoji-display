...
_KEYWORD_GROUPS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("MUSIC", ("music", "musical", "note", "song", "музыка", "нота")),
    ...
    ("FOOD", ("food", "savoring", "savouring", "pizza", "burger", "eat", "еда", "вкус")),
    ("LAUGH", ("laugh", "joy", "tears of joy", "rofl", "grin", "сме", "хохот")),
    ("WINK", ("wink", "подмиг")),
    ("STAR", ("star", "glowing star", "sparkles", "sparkle", "звезда", "звезд", "блест")),
...
def normalize_emoji(symbol: str, name: str | None = None) -> EmojiMatch:
    ...
    return _match(requested, "NEUTRAL", "fallback")
